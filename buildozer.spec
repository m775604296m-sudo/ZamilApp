...
# تم تحديد إصدار pillow بدقة لمنع تعارض مكاتب الـ JPEG أثناء البناء السحابي
requirements = python3, kivy==2.3.0, kivymd==1.1.1, arabic_reshaper, python-bidi, pillow==9.5.0
...
# (str) Icon of the application (قم بإلغاء التعليق وتعديل المسار إذا كنت تملك أيقونة جاهزة)
